// GET /api/training?days=14 — training session data
// Today's session, weekly volume, strength progression
...
export default async function handler(req, res) {
  ...
  try {
    const upstream = await fetch(`${apiBase}/training/recent?days=${encodeURIComponent(days)}`, {
